    ...
    <div className="p-8">
      <div className="mb-8 flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Gerencie todas as suas candidaturas.</p>
        </div>
        <Button asChild>
          <Link href="/dashboard/jobs/new">+ Nova vaga</Link>
        </Button>
      </div>
            ...
            >
              <div className="flex items-start justify-between">
                ...
                <div className="text-right">
                  ...
                  {job.is_favorite && <span className="ml-2">⭐</span>}
                </div>
              </div>
            </Link>
          ))}
